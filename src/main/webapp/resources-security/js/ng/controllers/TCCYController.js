angular.module('app').controller('TCCYController', ['$scope', '$http', 'GridManager', 'ModalManager',
    function ($scope, $http, GridManager, ModalManager) {
    angular.extend($scope, {url: 'ccy/list', saveURL: 'ccy/put', deleteURL: 'ccy/delete', init: {}, countries: []});
